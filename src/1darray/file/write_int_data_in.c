...
void lip_write_1darray_i8_data_in(struct lip_file *io, unsigned size,
                                  int8_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_i16_data_in(struct lip_file *io, unsigned size,
                                   int16_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_i32_data_in(struct lip_file *io, unsigned size,
                                   int32_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_i64_data_in(struct lip_file *io, unsigned size,
                                   int64_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_u8_data_in(struct lip_file *io, unsigned size,
                                  uint8_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_u16_data_in(struct lip_file *io, unsigned size,
                                   uint16_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_u32_data_in(struct lip_file *io, unsigned size,
                                   uint32_t arr[])
{
    if (io->error) return;
...
void lip_write_1darray_u64_data_in(struct lip_file *io, unsigned size,
                                   uint64_t arr[])
{
    if (io->error) return;
