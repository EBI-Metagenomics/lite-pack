                               ...
                               int8_t const arr[])
{
    ...
    {
        io->error |= lip_store_i8(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(int8_t), 1, io->fp) != 1;
    }
}
                                ...
                                int16_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_i16(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(int16_t), 1, io->fp) != 1;
    }
}
                                ...
                                int32_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_i32(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(int32_t), 1, io->fp) != 1;
    }
}
                                ...
                                int64_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_i64(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(int64_t), 1, io->fp) != 1;
    }
}
                               ...
                               uint8_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_u8(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(uint8_t), 1, io->fp) != 1;
    }
}
                                ...
                                uint16_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_u16(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(uint16_t), 1, io->fp) != 1;
    }
}
                                ...
                                uint32_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_u32(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(uint32_t), 1, io->fp) != 1;
    }
}
                                ...
                                uint64_t const arr[])
{
    ...
    for (unsigned i = 0; i < size; ++i)
    {
        io->error |= lip_store_u64(buf, arr[i]) == 0;
        io->error |= fwrite(buf, sizeof(uint64_t), 1, io->fp) != 1;
    }
}
