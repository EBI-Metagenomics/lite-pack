...
static inline void store_u8(uint8_t buf[static 1], int val)
{
    buf[0] = first_byte(FMT_UINT_8);
    buf[1] = (uint8_t)val;
}

static inline void store_u16(uint8_t buf[static 1], int val)
{
...
static inline void store_u32(uint8_t buf[static 1], int val)
{
