...
unsigned __lip_store_negative_fixint(unsigned char buf[], int8_t val)
{
    buf[0] = __lip_first_byte_fix(LIP_FMT_NEGATIVE_FIXINT, val);
    return 1;
}

unsigned __lip_store_int8(unsigned char buf[], int8_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_INT_8);
    return 1 + lip_store_u8(buf + 1, val);
}

unsigned __lip_store_int16(unsigned char buf[], int16_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_INT_16);
    return 1 + lip_store_u16(buf + 1, val);
}

unsigned __lip_store_int32(unsigned char buf[], int32_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_INT_32);
    return 1 + lip_store_u32(buf + 1, val);
}

unsigned __lip_store_int64(unsigned char buf[], int64_t val)
{
...
unsigned __lip_store_positive_fixint(unsigned char buf[], uint8_t val)
{
    buf[0] = __lip_first_byte_fix(LIP_FMT_POSITIVE_FIXINT, val);
    return 1;
}

unsigned __lip_store_uint8(unsigned char buf[], uint8_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_UINT_8);
    return 1 + lip_store_u8(buf + 1, val);
}

unsigned __lip_store_uint16(unsigned char buf[], uint16_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_UINT_16);
    return 1 + lip_store_u16(buf + 1, val);
}

unsigned __lip_store_uint32(unsigned char buf[], uint32_t val)
{
    buf[0] = __lip_first_byte(LIP_FMT_UINT_32);
    return 1 + lip_store_u32(buf + 1, val);
}

unsigned __lip_store_uint64(unsigned char buf[], uint64_t val)
{
