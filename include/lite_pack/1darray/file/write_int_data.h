#ifndef LITE_PACK_1DARRAY_FILE_WRITE_INT_DATA_H
#define LITE_PACK_1DARRAY_FILE_WRITE_INT_DATA_H
...
LIP_API bool lip_write_1darray_i8_data(struct lip_file *io, unsigned size,
                                       int8_t const arr[]);

LIP_API bool lip_write_1darray_i16_data(struct lip_file *io, unsigned size,
                                        int16_t const arr[]);

LIP_API bool lip_write_1darray_i32_data(struct lip_file *io, unsigned size,
                                        int32_t const arr[]);

LIP_API bool lip_write_1darray_i64_data(struct lip_file *io, unsigned size,
                                        int64_t const arr[]);

/* UNSIGNED */

LIP_API bool lip_write_1darray_u8_data(struct lip_file *io, unsigned size,
                                       uint8_t const arr[]);

LIP_API bool lip_write_1darray_u16_data(struct lip_file *io, unsigned size,
                                        uint16_t const arr[]);

LIP_API bool lip_write_1darray_u32_data(struct lip_file *io, unsigned size,
                                        uint32_t const arr[]);

LIP_API bool lip_write_1darray_u64_data(struct lip_file *io, unsigned size,
                                        uint64_t const arr[]);
