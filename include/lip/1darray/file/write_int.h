#ifndef LIP_1DARRAY_FILE_WRITE_INT_H
#define LIP_1DARRAY_FILE_WRITE_INT_H
...
LIP_API bool lip_write_1darray_i8(struct lip_file *file, unsigned size,
                                  int8_t const arr[]);

LIP_API bool lip_write_1darray_i16(struct lip_file *file, unsigned size,
                                   int16_t const arr[]);

LIP_API bool lip_write_1darray_i32(struct lip_file *file, unsigned size,
                                   int32_t const arr[]);

LIP_API bool lip_write_1darray_i64(struct lip_file *file, unsigned size,
                                   int64_t const arr[]);

/* UNSIGNED */

LIP_API bool lip_write_1darray_u8(struct lip_file *file, unsigned size,
                                  uint8_t const arr[]);

LIP_API bool lip_write_1darray_u16(struct lip_file *file, unsigned size,
                                   uint16_t const arr[]);

LIP_API bool lip_write_1darray_u32(struct lip_file *file, unsigned size,
                                   uint32_t const arr[]);

LIP_API bool lip_write_1darray_u64(struct lip_file *file, unsigned size,
                                   uint64_t const arr[]);
