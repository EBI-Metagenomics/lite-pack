...
int main(void)
{
    for (int i = 0; i < 128; ++i)
    {
        ...
        if (__lip_format(ch) != LIP_FMT_POSITIVE_FIXINT) ERROR;
    ...
    for (int i = 0; i < 16; ++i)
    {
        ...
        if (__lip_format(ch) != LIP_FMT_FIXMAP) ERROR;
        if (__lip_format_fix_value(ch) != i) ERROR;
    }
    ...
    for (int i = 0; i < 16; ++i)
    {
        ...
        if (__lip_format(ch) != LIP_FMT_FIXARRAY) ERROR;
        if (__lip_format_fix_value(ch) != i) ERROR;
    }
    ...
    for (int i = 0; i < 32; ++i)
    {
        ...
        if (__lip_format(ch) != LIP_FMT_FIXSTR) ERROR;
        if (__lip_format_fix_value(ch) != i) ERROR;
    }
    ...
    for (int i = -32; i < 0; ++i)
    {
        ...
        if (__lip_format(ch) != LIP_FMT_NEGATIVE_FIXINT) ERROR;
        if (__lip_format_fix_value(ch) != i) ERROR;
    }
